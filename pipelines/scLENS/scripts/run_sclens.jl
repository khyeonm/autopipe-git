...
# Arguments: input_csv pca_out umap_out h5ad_out plot_out mp_plot_out
args = ARGS
input_csv  = args[1]
pca_out    = args[2]
umap_out   = args[3]
...
# Save MP distribution plot
println("Saving MP distribution plot -> $mp_plot_out")
mp_panel = scLENS.plot_mpdist(sclens_embedding)
save(mp_plot_out, mp_panel)
